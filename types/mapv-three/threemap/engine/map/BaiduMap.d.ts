/** @protected */
export class BaiduMap extends BaseMap {
    constructor(engine: any, map: any, options: any);
    near: number;
    _far: number;
    fov: number;
    projectionCoordsName: string;
    _engine: any;
    map: any;
    ...
    handleEventRightClick: (e: any) => void;
    handleEventDblClick: (e: any) => void;
    handleEventRightDblClick: (e: any) => void;
    ...
    normalizeMapPoint(input: any): any;
    normalizeProjectionPointArr(input: any): any;
    normalizeEarthPointArr(input: any): any;
